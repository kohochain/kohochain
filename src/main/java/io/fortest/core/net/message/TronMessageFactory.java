...
import io.fortest.common.overlay.message.MessageFactory;
 ...
 * msg factory.
 */
public class khcMessageFactory extends MessageFactory {

  @Override
  public khcMessage create(byte[] data) throws Exception {
    try {
      byte type = data[0];
  ...
  private khcMessage create(byte type, byte[] packed) throws Exception {
