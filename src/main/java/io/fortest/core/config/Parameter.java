...
//    public final int MAX_ACTIVE_WITNESS_NUM = Args.getInstance().getMaxActiveWitnessNum();
  ...
  public class NetConstants {
    ...
    public static final long NET_MAX_kht_PER_SECOND = 700L;
    public static final long MAX_kht_PER_PEER = 200L;
    ...
    public static final int MAX_kht_FETCH_PER_PEER = 1000;
  }
