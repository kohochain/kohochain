...
import io.fortest.common.entity.NodeInfo.ConfigNodeInfo;
import io.fortest.common.entity.NodeInfo.MachineInfo;
import io.fortest.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import io.fortest.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import io.fortest.common.entity.PeerInfo;
...
import io.fortest.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getkhcLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getkhcLastRemoteDisconnectReason();
