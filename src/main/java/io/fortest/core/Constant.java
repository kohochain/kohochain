...
public class Constant {
  ...
  public static final byte ADD_PRE_FIX_BYTE_MAINNET = (byte) 0x2e;   //2e + address, 地址K开头
  public static final String ADD_PRE_FIX_STRING_MAINNET = "2e";
  ...
  public static final long SUN_PER_ENERGY = 10; // 1 us = 100 DROP = 100 * 10^-6 fortest
  ...
  //Issued
  public static final long INIT_ISSUED_BALANCE = 43_200_000L;
  public static final double RATE_PER_YEAR = 0.75;
  public static final long BLOCK_NUM_ONE_YEAR = 365 * 24 * 1200;
