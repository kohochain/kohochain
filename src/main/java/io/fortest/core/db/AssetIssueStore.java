...
@Slf4j(topic = "DB")
@Component
public class AssetIssueStore extends khcStoreWithRevoking<AssetIssueCapsule> {
...
//        .collect(Collectors.toList());
    ...
    limit = limit > Parameter.DatabaseConstants.ASSET_ISSUE_COUNT_LIMIT_MAX ? Parameter.DatabaseConstants.ASSET_ISSUE_COUNT_LIMIT_MAX : limit;
