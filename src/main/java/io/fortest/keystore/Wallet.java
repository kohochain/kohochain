 ...
 *
 * <p><skhcg>Note:</skhcg> the Bouncy Castle Scrypt implementation {@link SCrypt}, fails to comply
...
public class Wallet {
  ...
  private static WalletFile createWalletFile(
    ...
    walletFile.setAddress(io.fortest.core.Wallet.encode58Check(ecKeyPair.getAddress()));
