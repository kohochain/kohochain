...
import static io.fortest.common.utils.ByteUtil.bigIntegerToBytes;
...
import io.fortest.common.crypto.sm2.SM2;
...
import io.fortest.common.crypto.jce.ECKeyAgreement;
import io.fortest.common.crypto.jce.ECKeyFactory;
import io.fortest.common.crypto.jce.ECKeyPairGenerator;
import io.fortest.common.crypto.jce.ECSignatureFactory;
import io.fortest.common.crypto.jce.khcCastleProvider;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(khcCastleProvider.getInstance(), secureRandom);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(khcCastleProvider.getInstance())
