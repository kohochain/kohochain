 ...
 */
package io.fortest.common.runtime.vm.program.invoke;

import static io.fortest.common.runtime.vm.program.InternalTransaction.khtType.kht_CONTRACT_CALL_TYPE;
import static io.fortest.common.runtime.vm.program.InternalTransaction.khtType.kht_CONTRACT_CREATION_TYPE;
...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.khtType khtType,
    ...
    if (khtType == kht_CONTRACT_CREATION_TYPE) {
    ...
    } else if (khtType == kht_CONTRACT_CALL_TYPE) {
