package io.fortest.common.overlay.client;
...
import io.fortest.common.overlay.server.khcChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "khcJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    khcChannelInitializer khcChannelInitializer = ctx
        .getBean(khcChannelInitializer.class, remoteId);
    khcChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(khcChannelInitializer);
