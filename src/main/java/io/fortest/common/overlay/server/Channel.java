...
import io.fortest.common.overlay.discover.node.statistics.NodeStatistics;
import io.fortest.common.overlay.message.DisconnectMessage;
import io.fortest.common.overlay.message.HelloMessage;
import io.fortest.common.overlay.message.MessageCodec;
import io.fortest.common.overlay.message.StaticMessages;
import io.fortest.core.db.ByteArrayWrapper;
import io.fortest.core.net.khcNetHandler;
...
public class Channel {
  ...
  @Autowired
  private khcNetHandler khcNetHandler;
  ...
  private khcState khcState = khcState.INIT;
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    pipeline.addLast("lengthDecode", new khtProtobufVarint32FrameDecoder(this));
    ...
    khcNetHandler.setChannel(this);

    p2pHandler.setMsgQueue(msgQueue);
    khcNetHandler.setMsgQueue(msgQueue);
  }
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    ctx.pipeline().addLast("data", khcNetHandler);
    setStartTime(msg.getTimestamp());
    setkhcState(khcState.HANDSHAKE_FINISHED);
  ...
  public void setkhcState(khcState khcState) {
    this.khcState = khcState;
    logger.info("Peer {} status change to {}.", inetSocketAddress, khcState);
  }
