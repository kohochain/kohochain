...
import io.fortest.common.overlay.message.PingMessage;
import io.fortest.common.overlay.message.PongMessage;
...
public class MessageQueue {
  ...
  private boolean needToLog(Message msg) {
    ...
    if (msg instanceof InventoryMessage &&
        ((InventoryMessage) msg).getInventoryType().equals(InventoryType.kht)) {
      return false;
    }
