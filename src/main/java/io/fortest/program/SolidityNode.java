...
import io.fortest.common.overlay.client.DatabaseGrpcClient;
...
import io.fortest.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  private void getBlock() {
    ...
    while (flag) {
      try {
        ...
        Protocol.Block block = getBlockByNum(blockNum);
  ...
  private void processBlock() {
    while (flag) {
      try {
        Protocol.Block block = blockQueue.take();
  ...
  private Protocol.Block getBlockByNum(long blockNum) {
    while (true) {
      try {
        ...
        Protocol.Block block = databaseGrpcClient.getBlock(blockNum);
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new khcApplicationContext(DefaultConfig.class);
